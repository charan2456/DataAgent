...
import { LLM, Agent } from '@/types/agent';
...
export const ChatInput = ({
  ...
  const handleChangeLLM = async (e: any) => {
    ...
    const curModel = selectedConversation.agent as Agent;
    const updateModel = {
      ...curModel,
      llm: newLLM,
    };
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full border-transparent pt-2 z-[99] bg-transparent">
      <div className="stretch w-full px-20 mt-4 flex flex-row gap-3">
        ...
        <div className="relative flex flex-grow flex-col border rounded-xl border-black/10 bg-white shadow-[0_0_10px_rgba(0,0,0,0.10)]">
          ...
          {showInputBox && (
            <textarea
              ref={textareaRef}
              className="m-0 w-full resize-none border-0 bg-transparent p-0 py-2 pr-2 pl-10 text-slate-800 md:py-3 md:pl-3 placeholder:text-slate-400 focus:outline-none focus:border-primary-500 focus:ring-primary-500 focus:ring-1 rounded-xl"
              style={{
                resize: 'none',
      ...
      <div className="px-3 pt-2 pb-3 text-center text-[12px] text-slate-500 md:px-4 md:pt-3 md:pb-6 bg-transparent">
        Powered by&nbsp;
        <a
          href="#"
          target="_blank"
