...
const Sidebar = <T,>({
  ...
  return isOpen ? (
    <div style={disableStyle} className="bg-gradient-to-br from-slate-50 to-slate-100">
      <div
        className={`fixed rounded-3xl rounded-l-none top-0 ${side}-0 z-40 flex h-full w-[260px] flex-none flex-col space-y-2 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 p-2 text-[13px] sm:relative sm:top-0 shadow-2xl`}
      >
    ...
    <div
      className={`fixed justify-center rounded-3xl rounded-l-none top-0 ${side}-0 z-40 flex h-full w-[80px] bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-[13px] sm:relative sm:top-0`}
    >
      <LogoIcon className="fixed top-5 left-5 w-10" />
