...
> The agent **decomposed a vague business question** into 3 autonomous steps — SQL extraction, Python analysis, and visualization — without any hardcoded workflow. It decided *which* tools to use, *in what order*, and *self-chained* them together.
